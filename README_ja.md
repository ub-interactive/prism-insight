...
- **スマートフィルタリング** — PRISM-Mobile で受け取るシグナル種別を調整できます
...
- **ライブ環境**: [analysis.stocksimulation.kr](https://analysis.stocksimulation.kr/) とスポンサーバナー参照
- **[GitHubディスカッション](https://github.com/dragon1086/prism-insight/discussions)**
...
- **プッシュ連携（任意）** — `firebase_bridge` 経由の FCM メタデータ書き込み／通知
...
| **プッシュ（任意）** | `firebase_bridge` 経由で FCM データを送信 |
...
**お問い合わせ**: [GitHub Issues](https://github.com/dragon1086/prism-insight/issues) | [Discussions](https://github.com/dragon1086/prism-insight/discussions)
