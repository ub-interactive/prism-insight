...
class USStockAnalysisOrchestrator:
    ...
    async def run_macro_intelligence(self, reference_date: str = None, language: str = "en") -> dict:
        ...
        try:
            ...
            from cores.data.prefetch import prefetch_us_macro_intelligence_data
    ...
    async def run_trigger_batch(self, mode: str, macro_context: dict = None, override_date: str = None):
        ...
        try:
            from ops.pipelines.trigger_batch import run_batch
            ...
            results_file = str(REPO_ROOT / f"trigger_results_us_{mode}_{effective_date}.json")
        ...
        try:
            ...
            if pdf_paths:
                try:
                    ...
                    from ops.pipelines.stock_tracking_agent import USStockTrackingAgent, app as tracking_app

                    async with tracking_app.run():
                        tracking_agent = USStockTrackingAgent()

                        trigger_results_file = str(REPO_ROOT / f"trigger_results_us_{mode}_{effective_date}.json")
...
if __name__ == "__main__":
    ...
    from ops.maintenance.check_market_day import is_us_market_day
