...
class USStockAnalysisOrchestrator:
    ...
    async def run_trigger_batch(self, mode: str, macro_context: dict = None, override_date: str = None):
        ...
        try:
            from scripts.trigger_batch import run_batch
    ...
    async def run_full_pipeline(self, mode: str, language: str = "en", override_date: str = None):
        ...
        try:
            ...
            # 5. Tracking / trading batch
            if pdf_paths:
                try:
                    logger.info("Starting US stock tracking system batch execution")

                    from scripts.stock_tracking_agent import USStockTrackingAgent, app as tracking_app
            ...
            import traceback
            logger.error(traceback.format_exc())
            from cores.openai_quota_utils import is_openai_quota_error
...
if __name__ == "__main__":
    ...
    from scripts.check_market_day import is_us_market_day
